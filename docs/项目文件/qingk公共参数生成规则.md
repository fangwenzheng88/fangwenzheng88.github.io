...
- [1. 公共参数及其生成代码](#1-公共参数及其生成代码)
    - [1.1. `v`](#11-v)
    - [1.2. `udid`](#12-udid)
    - [1.3. `timestamp`](#13-timestamp)
    - [1.4. `appid`](#14-appid)
    - [1.5. `sign`](#15-sign)
    - [1.6. `componentId`](#16-componentid)
    - [1.7. `terminal`](#17-terminal)
    - [1.8. `channel`](#18-channel)
    - [1.9. `os`](#19-os)
    - [1.10. `page`](#110-page)
    - [1.11. `step`](#111-step)
...
涪城应用为`vroxavqbrwcpstctxcxouwccaoqdvvsv`

## 1.5. `sign`

```javascript
/*
 * 序号10，Javascript md5() 函数 用于生成字符串对应的md5值
...
//var sign = md5('sign'+appid+udid+token+timestamp+'sign');
//token未登录为空
```
